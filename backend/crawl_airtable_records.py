    ...
    async with semaphore:
        ...
        try:
            ...
            update_fields = {
                ...
                airtable_config.campus_locations_field: to_airtable_tags(result.campus_locations),
                airtable_config.programs_field: sanitize_rich_text(result.programs),
                airtable_config.admission_methods_field: sanitize_rich_text(result.admission_methods),
                airtable_config.admission_score_field: sanitize_rich_text(result.admission_score),
